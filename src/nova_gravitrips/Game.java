...
public class Game {
    ...
    public void startGame(){
        ...
        do {
            ...
            player = playersList[currentPlayer];
        ...
        if (player.won){
            System.out.println("Congratulations to player " + player.getToken().getChar() + " for winning the game!");
        } else {
            System.out.println("Game over, it's a tie! There are "+ board.countEmptyCells() + " moves left!");
        }
    }
